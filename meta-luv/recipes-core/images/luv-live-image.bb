...
APPEND = "debug crashkernel=512M,high console=tty0,115200 console=ttyPCH0,115200 ip=dhcp log_buf_len=1M splash systemd.log_target=null quiet loglevel=0 crash_kexec_post_notifiers"
