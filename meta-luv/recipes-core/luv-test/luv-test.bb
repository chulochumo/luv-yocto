...
do_install_append() {
       ...
       # Install save_luv_netboot_results in bin directory
       install -d ${D}${bindir}
       install -m 0755 ${WORKDIR}/save_luv_netboot_results ${D}${bindir}
...
FILES_${PN} += "${sysconfdir}/luv/parsers/test-manager \
		${bindir}/save_luv_netboot_results"
